...
import it.geosolutions.geobatch.metocs.netcdf2geotiff.cf.*;
 ...
 * @author etj
 */
public class NetcdfIMCheckerSPI extends AbsCheckerSPI {

    private final static Logger LOGGER = LoggerFactory.getLogger(NetcdfIMCheckerSPI.class);
